...
const About = () => {
  ...
  return (
    <div className='flex flex-col md:gap-8 lg:gap-8  xl:gap-14'>
      ...
      <div className='bg-cover bg-center md:h-[500px] lg:h-[460px] xl:h-[500px] relative ' style={{backgroundImage :`url(${image_35})`}}>
          ...
          <section className='relative z-10 pt-[310px] flex flex-col justify-center items-center'>
              <h1 className='text-[#FFF] md:text-3xl lg:text-4xl mb-[40px] font-semibold font-playfair'>About Us</h1>
              ...
              <Link className='text-[#FFF] text-2xl font-semibold font-[Roboto]' to='/'>Home</Link>
                  ...
                  <h1 className='text-[#FFF] text-2xl font-semibold font-[Roboto]' to='/aboutus'>About</h1>
              </div>
          </section>
      ...
      <div className='md:px-8 lg:px-12 xl:px-20'>
        <h1 className='text-center md:text-3xl lg:text-4xl font-semibold mb-[32px]'>Our Story</h1>
        <motion.img src={image_36} alt='image_36' className='' variants={leftSideVariants} initial="hidden" animate={animated ? "visible" : "hidden"}/>
      </div>


      {/*  */}
      <motion.div className='md:px-8 lg:px-12 xl:px-20 flex flex-col md:gap-4 lg:gap-6 ' variants={bottomTopVariants1} initial="hidden" animate={animated ? "visible" : "hidden"}>
        <h1 className='md:text-xl lg:text-2xl font-medium'>Pure. Natural. Sustainable</h1>
        <p className='md:text-lg lg:text-xl font-[Roboto]'>Mewar Organics Pvt. Ltd., based in the historic city of Chittaurgarh, Rajasthan, is a premier nursery and landscaping firm dedicated to promoting biodiversity and
      ...
      {/*  */}
      <div className='md:px-8 lg:px-12 xl:px-20 flex flex-col'>
        <h1 className='text-center md:text-3xl lg:text-4xl font-semibold font-playfair mb-[10px]'>Our Vision</h1>
        <h1 className='text-center md:text-xl lg:text-2xl font-semibold font-playfair '>We believe in farming with care, for people, for the planet, and for generations to come.</h1>
        <div className='grid md:grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-4 xl:gap-10'>
            {/*  */}
            <div className='md:p-5 lg:p-4 xl:p-8 shadow-xl'>
                <img src={image_37} alt='image_37' className='w-full md:h-[348px] lg:h-[250px] xl:h-auto'/>
                <h1 className='md:text-2xl lg:text-xl xl:text-2xl font-playfair font-semibold my-5 text-center'>Greener Tomorrow</h1>
                <p className='md:text-lg  xl:text-xl font-[Roboto] text-center'>To create a healthier planet by promoting biodiversity, conserving native species, and developing sustainable green spaces that restore ecological balance.</p>
            </div>
            {/*  */}
            <div className='md:p-5 lg:p-4 xl:p-8 shadow-xl'>
               <img src={image_38} alt='image_38' className='w-full md:h-[348px] lg:h-[250px] xl:h-auto'/>
               <h1 className='md:text-2xl lg:text-xl xl:text-2xl  font-playfair font-semibold my-5 text-center'>Empowering Communities</h1>
            ...
            <div className='md:p-5 lg:p-4 xl:p-8 shadow-xl'>
              <img src={image_39} alt='image_39' className='w-full md:h-[348px] lg:h-[250px] xl:h-auto'/>
                <h1 className='md:text-2xl lg:text-xl xl:text-2xl  font-playfair font-semibold my-5 text-center'>Cultural Preservation</h1>
      ...
      {/*  */}
          <div className='md:px-8 lg:px-12 xl:px-20 flex flex-col'>
              <h1 className='md:text-3xl lg:text-4xl text-center font-semibold font-playfair mb-2'>Why Mewar Organics?</h1>
              <h1 className='md:text-xl lg:text-2xl text-center font-semibold font-playfair'>Bringing Nature’s Best to Your Home</h1>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 md:gap-7  lg:gap-4 xl:gap-7">
                {/*  */}
                  <div className="shadow-lg md:p-6 lg:p-5 xl:py-8 xl:px-7 rounded-lg" >
                      ...
                      <h1 className="text-center  font-bold md:text-xl lg:text-lg xl:text-xl mb-2 font-[Roboto] ">Native Plant Advocacy</h1>
                  ...
                  <div className="shadow-lg md:p-6 lg:p-5 xl:py-8 xl:px-7 rounded-lg">
                    <div className="overflow-hidden mb-[28px]">
                      ...
                      <h1 className="text-center  font-bold md:text-xl lg:text-lg xl:text-xl mb-2 font-[Roboto]">Innovative Solutions</h1>
                  ...
                  <div className="shadow-lg md:p-6 lg:p-5 xl:py-8 xl:px-7 rounded-lg">
                      ...
                      <h1 className="text-center  font-bold md:text-xl lg:text-lg xl:text-xl mb-2 font-[Roboto]">Expertise in Landscaping</h1>
                  ...
                  <div className="shadow-lg md:p-6 lg:p-5 xl:py-8 xl:px-7 rounded-lg">
                    <div className="overflow-hidden mb-[28px]">
                      ...
                      <h1 className="text-center  font-bold md:text-xl lg:text-lg xl:text-xl mb-2 font-[Roboto]">Environmentally Conscious</h1>
          ...
          {/*  */}
          <div className='md:px-8 lg:px-[80px] xl:px-[200px]'>
              <div className='flex gap-1 lg:gap-[150px] bg-[#55833D] md:px-12 md:py-5 lg:px-[30px] lg:py-[25px] md:justify-between items-center lg:justify-center'>
                <h1 className='md:text-xl xl:text-[28px] font-semibold text-[#fff] font-playfair'>Join Us in Embracing a Healthier, Greener Future!</h1>
                <div className='py-3 px-8 lg:px-[38px] lg:py-[24px] text-[#fff] shadow-lg border-[#FFF] rounded-lg border border-solid border-white hover:text-black hover:bg-white' onClick={handleClick}>
                    <Link className='text-base lg:text-xl  font-semibold' >Contact Us</Link>
                </div>
              </div>
          </div>
