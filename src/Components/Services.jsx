...
const Services = () => {
  ...
  return (
    <div className='flex flex-col lg:gap-8  xl:gap-14'>
      ...
      {/*  */}
      <div className='bg-cover bg-center md:h-[500px] lg:h-[460px] xl:h-[500px] relative' style={{backgroundImage:`url(${image_40})`}}>
          <div className="absolute inset-0 bg-stone-900 opacity-50 z-0"></div>
          {/* text */}
          <section className='relative z-10 pt-[300px] flex flex-col justify-center items-center '>   
                  <h1 className='text-[#FFF] font-semibold text-4xl font-playfair mb-[50px]'>Mewar Services</h1>
                  <div className='flex items-center justify-center gap-[2px]'>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                      ...
                      <h1 className='text-[#FFF] text-2xl font-semibold font-[Roboto]' to='/services'>Services</h1>
                  </div>
          </section>
      ...
      <div className='relative min-h-screen '>
          {/* left */}
          <div className='absolute top-[-40px] left-0 h-[532px]  w-[450px] bg-cover bg-left bg-no-repeat ' style={{backgroundImage:`url(${image_42})`}}>
          </div>
          {/* right */}
          <div className='absolute top-[-40px] right-0 h-[532px]  w-[450px] bg-cover bg-right bg-no-repeat ' style={{backgroundImage:`url(${image_41})`}}>
          </div>

          <div className='md:px-8 lg:px-12 xl:px-20'>
            <h1 className='text-center md:text-3xl lg:text-4xl font-playfair font-semibold mb-[10px]'>Our Services</h1>
            <h1 className='text-center text-lg font-semibold font-playfair mb-[32px]'>Sustainable Solutions for a Greener Future</h1>
            <p className='md:text-lg lg:text-xl font-[Roboto] mb-8'>
            ...
            {/*  */}
            <div className='grid grid-cols-12 justify-center gap-10 lg:gap-5'>
                {/* 1st */}
                <div className='relative md:col-span-6 lg:col-span-3' onClick={handleClick}>
                  <div className='h-[520px] lg:h-[520px] xl:h-[580px] shadow-xl  md:p-5 md:p-5 lg:p-4 xl:p-6 border border-[#55833D] border-2 border-solid'>
                    ...
                    <h1 className='md:py-3 lg:py-3 xl:py-5 lg:text-base xl:text-lg font-bold font-playfair text-center'>Educational Workshops & Awareness:</h1>
                    <h1 className='lg:text-sm xl:text-base font-medium font-[Roboto] '>Conducting workshops on plant care, organic gardening, and biodiversity
                ...
                {/* 2nd */}
                <div className='relative md:col-span-6 lg:col-span-3' onClick={handleClick}>
                    <div className='h-[520px] lg:h-[520px] xl:h-[580px] shadow-xl md:p-5 lg:p-4 xl:p-6 border border-[#55833D] border-2 border-solid'>
                            <div className='overflow-hidden'>
                            ...
                            <h1 className='md:py-3 lg:py-3 xl:py-5 lg:text-base xl:text-lg font-bold font-playfair text-center'>Garden Maintenance</h1>
                            <h1 className='lg:text-sm xl:text-base font-medium font-[Roboto] '>Long-term care and growth management.</h1>
                        </div>
                        {/*  */}
                        <div className=' absolute bottom-[-14px] left-1/2'>
                            <div className='flex items-center justify-center w-8 h-8 rounded-full bg-[#55833D]'>
              ...
              <div className='relative md:col-span-6 lg:col-span-3' onClick={handleClick}>
                <div className='h-[520px] lg:h-[520px] xl:h-[580px] shadow-xl md:p-5 lg:p-4 xl:p-6 border border-[#55833D] border-2 border-solid'>
                  <div className='overflow-hidden'>
                    ...
                    <h1 className='md:py-3 lg:py-3 xl:py-5 lg:text-base xl:text-lg font-bold font-playfair text-center'>Planning and Consulting</h1>
                    <h1 className='lg:text-sm xl:text-base font-medium font-[Roboto]'>Landscape designs for residential and commercial projects</h1>
                </div>
                <div className=' absolute bottom-[-14px] left-1/2'>
                      <div className='flex items-center justify-center w-8 h-8 rounded-full bg-[#55833D]'>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className='relative md:col-span-6 lg:col-span-3' onClick={handleClick}> 
                  <div className='h-[520px] lg:h-[520px] xl:h-[580px] shadow-xl md:p-5 lg:p-4 xl:p-6 border border-[#55833D] border-2 border-solid'>
                    <div className='overflow-hidden'>
                      ...
                      <h1 className='md:py-3 lg:py-3 xl:py-5 lg:text-base xl:text-lg font-bold font-playfair text-center'>Vatika Creations</h1>
                      <h1 className='lg:text-sm xl:text-base font-medium font-[Roboto]'>
                ...
                {/* 5th */}
                <div className='relative md:col-span-6 lg:col-span-3 lg:col-start-2 ' onClick={handleClick}>
                    <div className='h-[520px] lg:h-[520px] xl:h-[580px]   shadow-xl md:p-5 lg:p-4 xl:p-6 border border-[#55833D] border-2 border-solid'>
                      <div className='overflow-hidden'>
                        ...
                        <h1 className='md:py-3 lg:py-3 xl:py-5 lg:text-base xl:text-lg font-bold font-playfair text-center'>Plantation and Sales</h1>
                        <h1 className='lg:text-sm xl:text-base font-medium font-[Roboto]'>A wide range of plants for personal, commercial, and public spaces.</h1>
                    </div>
                    <div className=' absolute bottom-[-14px] left-1/2'>
                      <div className='flex items-center justify-center w-8 h-8 rounded-full bg-[#55833D]'>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className='relative md:col-span-6 lg:col-span-3' onClick={handleClick}>
                  <div className='h-[520px] lg:h-[520px] xl:h-[580px] shadow-xl md:p-5 lg:p-4 xl:p-6 border border-[#55833D] border-2 border-solid'>
                    <div className='overflow-hidden'>
                      ...
                      <h1 className='md:py-3 lg:py-3 xl:py-5 lg:text-base xl:text-lg font-bold font-playfair text-center'>Miyawaki Forest Development</h1>
                      <h1 className='lg:text-sm xl:text-base font-medium font-[Roboto]'>Dense, multi-layered forests to enhance biodiversity.</h1>
                  </div>
                  <div className=' absolute bottom-[-14px] left-1/2'>
                      <div className='flex items-center justify-center w-8 h-8 rounded-full bg-[#55833D]'>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                {/* 7th */}
                <div className='relative md:col-span-6 lg:col-span-3 md:col-start-4' onClick={handleClick}>
                  <div className='h-[520px] lg:h-[520px] xl:h-[580px] shadow-xl md:p-5 lg:p-4 xl:p-6 border border-[#55833D] border-2 border-solid'>
                    <div className='overflow-hidden'>
                      ...
                      <h1 className='md:py-3 lg:py-3 xl:py-5 lg:text-base xl:text-lg font-bold font-playfair text-center'>Custom Garden Solutions</h1>
                      <h1 className='lg:text-sm xl:text-base font-medium font-[Roboto]'>
                        • Kitchen Gardens <br/>
                        • Balcony Gardens <br/>
                        • Terrace Gardens <br/>
...
<div className='md:px-[60px] lg:px-[90px] xl:px-[300px] mt-16'>
  <div className='flex items-center justify-center md:gap-10 lg:gap-20 px-[50px] py-[40px] bg-[#55833D]'>
    <div className='flex flex-col gap-2'>
      <h1 className='md:text-2xl font-playfair text-[#FFF] font-semibold'>
        Looking for the Best Organic Solutions?
      </h1>
      <h1 className='text-lg font-[Roboto] text-[#FFF] font-medium'>
        Partner with us for sustainable, high-quality organic products.
      </h1>
    </div>

    {/* Apply group class here */}
    <div className='group px-8 py-4 rounded-lg text-[#FFF] bg-[#55833D] border border-white border-b-4 hover:text-black hover:bg-white' onClick={handleContact}>
      <button className='w-[100px] flex items-center gap-2 lg:text-sm xl:text-base font-medium font-[Roboto]'>
        GET A QUOTE
        <svg
