...
const Miyawaki = () => {
  ...
  return (
    <div className='flex flex-col md:gap-8 lg:gap-8  xl:gap-14'>
        {/* 1st section */}
        <div className='relative  md:h-[500px] lg:h-[460px] xl:h-[500px] bg-center bg-cover' style={{backgroundImage:`url(${image_91})`}}>
             <div className="absolute inset-0 bg-stone-900 opacity-50 z-0"></div>
            {/*  */}
            <section className='relative z-10 flex flex-col gap-[50px] items-center pt-[278px]'>
                <h1 className='text-[#fff] text-6xl font-playfair'>Miyawaki Forest</h1>
                <div className='flex items-center gap-[5px]'>
                    ...
                    <Link className='text-[#fff] text-2xl font-semibold font-[Roboto]' to='/portfolio'>Portfolio</Link>
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                    ...
                    <h1 className='text-[#fff] text-2xl font-semibold font-[Roboto]'>Miyawaki project</h1>
                </div>
            </section>
            {/*  */}
        ...
        {/* 2nd Section */}
        <div className='flex flex-col md:px-8 lg:px-12 xl:px-20'>
            {/* 1st */}
           <div className='mb-[32px] flex flex-col justify-center items-center gap-2'>
                <h1 className='md:text-3xl lg:text-4xl xl:text-[44px] font-semibold text-[#000] font-playfair'>The Miyawaki Forest Project</h1>
                <h1 className='md:text-2xl lg:text-[28px] italic text-[#212529] font-[Roboto]'>Urban Biodiversity Project</h1>
                <hr className='w-[120px] lg:w-[148px] h-[4px] bg-[#55833D]'/>
           </div>
           {/* 2nd */}
           <div className=' flex flex-col items-start'>
                <h1 className='md:mb-[16px] lg:mb-[26px] text-[#000] font-playfair md:text-2xl lg:text-[32px] font-semibold'>Project Details</h1>
                <h1 className='md:mb-[16px] lg:mb-[20px] text-[#000] font-[Roboto] md:text-xl lg:text-2xl font-medium'>Description</h1>
                <p className='text-[#212529] font-[Roboto] md:text-lg lg:text-xl'>The Miyawaki Forest Project aims to create dense, fast-growing, and self-sustaining green spaces using the Miyawaki afforestation method. 
           ...
           <div className='my-[20px] flex flex-col items-start'>
                <h1 className='md:mb-[16px] lg:mb-[26px] text-[#000] font-playfair md:text-2xl lg:text-[28px] font-medium'>Challenges & Solutions</h1>
                <h1 className='md:mb-[16px] lg:mb-[20px] text-[#000] font-[Roboto] md:text-xl lg:text-2xl font-medium'>Challenges Faced:</h1>
                <ol className='text-[#212529] font-[Roboto] md:text-lg lg:text-xl flex flex-col md:gap-[8px] lg:gap-[12px]'>
           ...
           <div className='mb-[20px] flex flex-col'>
                <h1 className='md:mb-[20px] lg:mb-[26px] text-[#000] font-playfair md:text-2xl lg:text-[28px] font-medium'>Image Gallery</h1>
                <div className='grid grid-cols-12  md:gap-4 lg:gap-10'>
                    <div className='col-span-6'>
                        <img src={image_92} alt='image_92' className=''/>
                    </div>
                    <div className='col-span-6'>
                        <div className='grid grid-cols-2 gap-4 lg:gap-5'>
                            <img src={image_93} alt='image_93' className=''/>
                            <img src={image_94} alt='image_94' className=''/>
                            <img src={image_95} alt='image_95' className=''/>
                            <img src={image_96} alt='image_96' className=''/>
                        </div>
                    </div>
                </div>
           </div>
           {/* 5th  */}
           <div className='flex flex-col md:gap-5 lg:gap-7'>
                <h1 className='text-[#000] font-playfair md:text-2xl lg:text-[28px] font-medium'>Result & Impact</h1>
                <ol className='text-[#212529] font-[Roboto] md:text-lg lg:text-xl flex flex-col gap-[12px]'>
        ...
        {/* 3rd Section */}
        <div className='mb-[24px] flex flex-col justify-center items-center'>
            <h1 className='mb-[20px] text-3xl lg:text-4xl xl:text-[44px] font-semibold text-[#000] font-playfair'>Interested in similar projects?</h1>
            <button className='md:mb-6 lg:mb-9 md:px-4 lg:px-8 md:py-2 lg:py-4 border border-[#55833D] rounded-xl border-[3px] text-[#212529] md:text-lg lg:text-xl font-medium font-[Roboto] hover:bg-[#55833D] hover:text-[#fff]' onClick={handleContact}>
                Get in Touch
            </button>
            <button className='bg-[#55833D] md:px-6 lg:px-8 md:py-2.5 text-[#fff] text-2xl lg:text-[28px] font-medium font-[Roboto] underline' onClick={handlePortfolio}>
